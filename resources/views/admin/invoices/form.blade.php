<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <p v-if="errors.invoice_no" class="error alert alert-danger">@{{errors.invoice_no[0]}}</p>
        </div>
        <div class="form-group">
            <label>Client</label>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <p v-if="errors.client_address" class="error alert alert-danger">@{{errors.client_address[0]}}</p>
        </div>
        <div class="form-group">
            <label>Status</label>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <p v-if="errors.title" class="error alert alert-danger">@{{errors.title[0]}}</p>
        </div>
        <div class="row">
            <div class="col-sm-6">
                <label>Invoice Date</label>
                <input type="date" class="form-control" v-model="form.invoice_date">
                <p v-if="errors.invoice_date" class="error alert alert-danger">@{{errors.invoice_date[0]}}</p>
            </div>
            <div class="col-sm-6">
                <label>Due Date</label>
                <input type="date" class="form-control" v-model="form.due_date">
                <p v-if="errors.due_date" class="error alert alert-danger">@{{errors.due_date[0]}}</p>
            </div>
        </div>
    </div>
</div>
