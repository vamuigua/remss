                                        ...
                                        @if ($notification->data['notification_type'] == 'invoice paid')
                                            ...
                                            <div>
                                                ...
                                                <div class="timeline-footer">
                                                    <a class="btn btn-success btn-sm" href="/admin/payments/{{$notification->data['id']}}">Read more</a>
                                                    @if ($notification->read_at == null)
                                                        <a class="btn btn-primary btn-sm" href="/admin/notifications/{{$notification->id}}/notificationRead">Mark as Read</a>
                                                    @endif
                                                </div>
                                                </div>
                                            </div>
